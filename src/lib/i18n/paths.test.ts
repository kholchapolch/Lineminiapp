...
import { defaultBadgesPath, localizedMissionPath, localizedPath, localizedProductPath, swapLocaleInPath } from "@/lib/i18n/paths";
...
describe("i18n paths", () => {
  ...
  it("builds localized mission detail paths", () => {
    expect(localizedMissionPath("th", "wide-architect-tier-2")).toBe(
      "/th/my-missions/wide-architect-tier-2",
    );
  });
