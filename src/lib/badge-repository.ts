...
const fallbackBadgeRules: BadgeRuleConfig[] = [
  ...
  createFallbackRule({ id: 3, code: "portrait-master", name: "Portrait Master", badgeType: "quest", displayCategory: "Achievement badge", displayGroup: "Client Excel quest rules", description: "Own any one Portrait Master lens from the client SKU list.", sortOrder: 30, requiredCount: 1, imageText: "Portrait", groups: [{ label: "Own any one Portrait Master lens", matchType: "any", requiredCount: 1, skus: ["SEL35F14GM", "SEL50F14GM", "SEL50F12GM", "SEL85F14GM", "SEL85F14GM2", "SEL135F18GM"] }] }),
  createFallbackRule({ id: 4, code: "wide-architect", name: "Wide Architect", badgeType: "quest", displayCategory: "Achievement badge", displayGroup: "Client Excel quest rules", description: "Own any one Wide Architect lens from the client SKU list.", sortOrder: 40, requiredCount: 1, imageText: "Wide", groups: [{ label: "Own any one Wide Architect lens", matchType: "any", requiredCount: 1, skus: ["SEL1224GM", "SEL14F18GM", "SEL16F18G", "SEL20F18G", "SEL1625G", "SEL1635GM", "SEL1635GM2", "SEL1635Z", "SEL2470GM", "SEL2470GM2", "SEL2450G", "SELC1635G", "SEL1655G", "SEL2070G", "SEL24105G", "SEL2470Z", "SEL24F14GM", "SEL24F28G", "SEL2870GM", "SEL35F14GM", "SEL35F18F", "SELP1635G", "SELP18110G", "SELP28135G"] }] }),
  createFallbackRule({ id: 5, code: "the-visionary", name: "The Visionary", badgeType: "quest", displayCategory: "Achievement badge", displayGroup: "Client Excel quest rules", description: "Own any one Sharp Shooter / The Visionary lens from the client SKU list.", sortOrder: 50, requiredCount: 1, imageText: "Visionary", groups: [{ label: "Own any one Sharp Shooter / The Visionary lens", matchType: "any", requiredCount: 1, skus: ["SEL100400GM", "SEL400800G", "SEL200600G", "SEL300F28GM", "SEL400F28GM", "SEL600F40GM"] }] }),
  createFallbackRule({ id: 6, code: "trinity-master", name: "Trinity Master", badgeType: "quest", displayCategory: "Achievement badge", displayGroup: "Client Excel quest rules", description: "Own one 16-35 GM family lens, one 24-70 GM family lens, and one 70-200 GM family lens.", sortOrder: 60, requiredCount: 3, imageText: "Trinity", groups: [{ label: "Own one 16-35 GM family lens", matchType: "any", requiredCount: 1, skus: ["SEL1635GM", "SEL1635GM2"] }, { label: "Own one 24-70 GM family lens", matchType: "any", requiredCount: 1, skus: ["SEL2470GM", "SEL2470GM2"] }, { label: "Own one 70-200 GM family lens", matchType: "any", requiredCount: 1, skus: ["SEL70200GM", "SEL70200GM2"] }] }),
  createFallbackRule({ id: 7, code: "trinity-active", name: "Trinity Active", badgeType: "quest", displayCategory: "Achievement badge", displayGroup: "Client Excel quest rules", description: "Own all three Trinity Active lenses from the client SKU list.", sortOrder: 70, requiredCount: 3, imageText: "Active", groups: [{ label: "Own all Trinity Active lenses", matchType: "all", requiredCount: 3, skus: ["SEL2450G", "SEL1625G", "SEL70200G2"] }] }),
  createFallbackRule({ id: 8, code: "all-rounder", name: "All Rounder", badgeType: "quest", displayCategory: "Achievement badge", displayGroup: "Client Excel quest rules", description: "Own any three of the four All Rounder lenses from the client SKU list.", sortOrder: 80, requiredCount: 3, imageText: "All Rounder", groups: [{ label: "Own any three All Rounder lenses", matchType: "min_count", requiredCount: 3, skus: ["SEL2070G", "SELP1635G", "SEL1635Z", "SEL70200G"] }] }),
  createFallbackRule({ id: 9, code: "f2-master", name: "F2 Master", badgeType: "quest", displayCategory: "Achievement badge", displayGroup: "Client Excel quest rules", description: "Own both F2 Master lenses from the client SKU list.", sortOrder: 90, requiredCount: 2, imageText: "F2", groups: [{ label: "Own both F2 Master lenses", matchType: "all", requiredCount: 2, skus: ["SEL2870GM", "SEL50150GM"] }] }),
  createFallbackRule({ id: 10, code: "the-magnifier", name: "The Magnifier", badgeType: "quest", displayCategory: "Achievement badge", displayGroup: "Client Excel quest rules", description: "Own any one macro lens from the client SKU list.", sortOrder: 100, requiredCount: 1, imageText: "Macro", groups: [{ label: "Own any one macro lens", matchType: "any", requiredCount: 1, skus: ["SEL100M28GM", "SEL90M28G"] }] }),
];
